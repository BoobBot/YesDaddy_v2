...
riddles = [
    ("I'm light as a feather, but even the world's strongest man couldn't hold me for long. What am I?", "breath"),
    ...
    ("What has a neck but no head?", ("a bottle", "a guitar", "a shirt")),
    ...
    ("Where does today come before yesterday?", "a dictionary"),
    ("What goes up and down but doesnt move?", "a staircase"),
    ("It belongs to you, but other people use it more than you do. What is it?", "your name"),
    ("What has legs, but doesnt walk?", "a table"),
    ...
    ("If your uncle’s sister is not your aunt, what relation is she to you?", "your mom"),
    ("What begins with an e ends with an e and only contains one letter?", "an envelope"),
    ...
    ("What has ten letters and starts with gas?", "automobile"),
    ("Jared’s father has three sons: Snap, Crackle and…?", "Jared"),
...
trivia_questions = [
    ...
    ("Who is credited with creating the theory of relativity?", "albert einstein"),
    ...
    ("Which city is famous for its Leaning Tower?", "pisa"),
    ...
    ("What is the tallest tree in the world?", "redwood"),
