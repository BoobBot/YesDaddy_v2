class Guild:
    def __init__(self, guild_id, member_data=None, tickets=None,support_tickets=None, config=None, lvl_roles=None, bonus_roles=None, text_reactions=None, shop_roles=None):
